...
# Ambil & filter pair USDT perpetual futures berdasarkan volume 24 jam.
...
def get_usdt_pairs(max_pairs: int, min_volume_usdt: float) -> List[str]:
    """
    Ambil semua pair USDT yang statusnya TRADING dan contractType = PERPETUAL
    dari Binance Futures, lalu filter hanya yang 24h quote volume >= min_volume_usdt.

    Return: list symbol lowercase untuk dipakai di WebSocket stream.
    """
