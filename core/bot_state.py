...
class BotState:
    ...
    last_update_id: Optional[int] = None  # untuk Telegram getUpdates
...
def load_bot_state() -> None:
    """Load scanning/min_tier/cooldown/min_volume/max_pairs dari file (jika ada)."""
...
def save_bot_state() -> None:
    """Simpan scanning/min_tier/cooldown/min_volume/max_pairs ke file."""
    try:
        data = {
